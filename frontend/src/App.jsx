    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/moviedetails/:id" element={<MovieDetails />} /> // Add a
          route for MovieDetails
          <Route
            path="/movies/searchresults/:query"
            element={<SearchResults />}
          />{" "}
          // Add a route for MovieDetails
          ...
          {categories.map((category) => (
            <Route
              ...
              element={<Movies categoryId={category.id} />}
            />
          ))}
        </Routes>
      </Router>
